        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8">
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 p-6 rounded-lg">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-emerald-50 text-blue-700 py-4 rounded-lg font-bold text-lg transition-all hover:scale-105 shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
